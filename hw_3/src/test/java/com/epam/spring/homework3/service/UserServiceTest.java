...
class UserServiceTest {
    ...
    void testRegisterClient() {
        ...
        UserDto result = userService.registerClient(userDto);
        ...
        assertThat(user.isEnable(), equalTo(true));
    ...
    void testRegisterClientThrowsExceptionIfUserAlreadyExists() {
        ...
        // then
        assertThrows(EntityAlreadyExistsException.class, () -> userService.registerClient(userDto));
    }
